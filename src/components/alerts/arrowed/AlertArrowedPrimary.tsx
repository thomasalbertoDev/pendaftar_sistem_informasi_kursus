...
interface AlertArrowedPrimaryProps {
  title: string;
  text: string;
  icon: string;
  width?: number;
...
const AlertArrowedPrimary: React.FC<AlertArrowedPrimaryProps> = ({ title, text, icon, width, onClick }) => {
  return (
    <>
...
export default AlertArrowedPrimary;
