...
interface AlertArrowedSecondaryProps {
  title: string;
  text: string;
  icon: string;
  width?: number;
...
const AlertArrowedSecondary: React.FC<AlertArrowedSecondaryProps> = ({ title, text, icon, width, onClick }) => {
  return (
    <>
...
export default AlertArrowedSecondary;
