...
interface AlertArrowedDangerProps {
  title: string;
  text: string;
  icon: string;
  width?: number;
...
const AlertArrowedDanger: React.FC<AlertArrowedDangerProps> = ({ title, text, icon, width, onClick }) => {
  return (
    <>
...
export default AlertArrowedDanger;
