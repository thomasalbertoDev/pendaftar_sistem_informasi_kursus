...
interface AlertArrowedWarningProps {
  title: string;
  text: string;
  icon: string;
  width?: number;
...
const AlertArrowedWarning: React.FC<AlertArrowedWarningProps> = ({ title, text, icon, width, onClick }) => {
  return (
    <>
...
export default AlertArrowedWarning;
