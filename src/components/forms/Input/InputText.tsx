  ...
  return (
    <>
      <div className="mb-5">
        ...
        <input id={id} type="text" name={name} value={value} onChange={onChange} placeholder={placeholder} className={`form-input ${error ? 'error' : ''} mb-1 dark:text-white py-3 rounded-lg`} />
