...
const SwitchOutlineDefault: React.FC<SwitchOutlineDefaultProps> = ({ value, onChange }) => {
  return (
    <>
      <label className="w-12 h-6 relative">
        <input value={value ? 'true' : 'false'} type="checkbox" className="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer" id="custom_switch_checkbox1" onChange={onChange} />
