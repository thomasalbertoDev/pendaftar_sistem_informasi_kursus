...
const SwitchOutlineRounded: React.FC<SwitchOutlineRoundedProps> = ({ value, onChange }) => {
  return (
    <>
      <label className="w-12 h-6 relative">
        <input id="custom_switch_checkbox1" type="checkbox" value={value ? 'true' : 'false'} className="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer" onChange={onChange} />
